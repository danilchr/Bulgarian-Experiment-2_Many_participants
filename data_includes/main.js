...
experiment_path=experiment_path+'series_many_participants/';
...
{
  message_for_the_type_of_experiment = "Много дълъг тест на експеримент "+number_of_experiment_as_string;
...
//Sequence("intro", "intro1",  "demo", "trials",  "demo1",  "demo2", "expbegin", sepWith("sendAsync", "experiment"), "Sync", SendResults(), "bye");


////Sequence("intro", "intro1", "trials",  "demo1",  "demo2", "expbegin", sepWith("sendAsync", randomize("experiment")), "Sync", SendResults(), "bye")

////Sequence("intro", "intro1", "trials",  "demo1",  "demo2", "expbegin", sepWith("sendAsync","experiment"), "Sync", SendResults(), "bye")
...
/////////InitiateRecorder("https://ibexfarm.ung.si/uporabniki/dk0035/experiment2/short_test_results/mediarec.php", "Това е тест на новата ситемата. Не използвайте това при реалния експеримент, защото резултатите НЯМА да бъдат изпратени към сървъра.")
 ...
 //InitiateRecorder(php_file_path, php_file_path+'\n'+stimuli_path)
 InitiateRecorder(php_file_path, "Моля, разрешете на браузъра достъп до микрофона. След това натиснете връзката по-долу.")
